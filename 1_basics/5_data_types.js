 ...
 * 지정되는 값이다.
 * 
 * 직접 undefined로 값을 초기화하는건 지향해야 한다.
 */
let noInit;
console.log(noInit);
 ...
 * null 타입
 * 
 * undefined과 마찬가지로 값이 없다는 뜻이나
 * js에서는 개발자가 명시적으로 없는 값으로 초기화 할때
 * 사용한다.
 */
let init = null;
console.log(init);
console.log(typeof init); //타입이 오브젝트로 잡히는건 버그임
console.log('------------------------');
 ...
 * Array 타입
 * 
 * 값을 릴스트로 나열 할 수 있는 타입이다.
 */
const iveMemversArray = [
    '안유진',
    '가을',
    '레이',
    '장원영',
 ...
 * 1씩 올라감.
 */
console.log(iveMemversArray[0]);
console.log(iveMemversArray[5]);

iveMemversArray[0] = '코드팩토리';
console.log(iveMemversArray);
console.log(typeof iveMemversArray);
